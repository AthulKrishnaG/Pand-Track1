...
if(isset($_POST["btnpatientUp"]))
{
	...
	if($updateresult) 
	{
		$msg = urlencode("Patient data updated successfully!");
		
		echo "<script> window.location.href ='success2.php?msg=$msg'; </script>";
		exit();
	} 
	else 
	{
...
if(isset($_POST["btndiseaseUp"]))
{
	...
	if($updateresult) 
	{
		$msg = urlencode("Disease data updated successfully!");
...
if(isset($_POST["btnsymptomsUp"]))
{
	...
	if($updateresult) 
	{
		$msg = urlencode("Symptoms data updated successfully!");
...
if(isset($_POST["btnmedicinesup"]))
{
	...
	if($updateresult) 
	{
		$msg = urlencode("Medicine  data updated successfully!");
...
if(isset($_POST["btnsourceup"]))
{
	...
	if($updateresult) 
	{
		$msg = urlencode("Source data updated successfully!");
...
if(isset($_POST["btnhotspotUp"]))
{
	...
	if($updateresult) 
	{
		$msg = urlencode("Hotspot data updated successfully!");
...
if(isset($_POST["btncontactUp"]))
{
	...
	if($updateresult) 
	{
		$msg = urlencode("Contact data updated successfully!");
...
if(isset($_POST["btnprimarycontactUp"]))
{
	...
	if($updateresult) 
	{
		$msg = urlencode("Primary contact data updated successfully!");
...
if(isset($_POST["btnhistoryUp"]))
{
	...
	if($updateresult) 
	{
		$msg = urlencode("History data updated successfully!");
...
if(isset($_POST["btndoctorUp"]))
{
	...
	if($updateresult) 
	{
		$msg = urlencode("Doctor data updated successfully!");
...
if(isset($_POST["btndailydutiesUp"]))
{
	...
	if($updateresult) 
	{
		$msg = urlencode("Daily duty data updated successfully!");
...
if(isset($_POST["btndischargeUp"]))
{
	...
	if($updateresult) 
	{
		$msg = urlencode("Discharge data updated successfully!");
