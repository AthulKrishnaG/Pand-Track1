                  ...
                  <form class="form form-horizontal" action="phpcodes-Insert.php" method="post">
                    <div class="form-body">
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-md-9">
                          <select id="state" name="state" class="form-control" required onchange="populateDistricts()">
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-md-9">
                          <input type="date" id="c_explanation_activities_date" name="c_explanation_activities_date" class="form-control" required>
                        </div>
                      </div>
