                ...
                <div class="card-body">
                  ...
                  <form class="form form-horizontal" action="phpcodes-Insert.php" method="post" novalidate>
                    <div class="form-body">
                      ...
                      <div class="form-group row">
                        <label class="col-md-3 label-control" for="d_m_startingdate">Medicines Starting Date <span style="color:red">*</span></label>
                        <div class="col-md-9">
                          <input type="date" id="d_m_startingdate" name="d_m_startingdate" class="form-control" required>
                          <div class="invalid-feedback">Please enter the starting date.</div>
                        </div>
                      </div>
