          ...
          <div class="row breadcrumbs-top">
            <div class="breadcrumb-wrapper col-12">
              <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="#">Medicine Info</a>
                </li>
                <li class="breadcrumb-item active"><a href="#">Medicine Info</a>
                </li>
              </ol>
            </div>
          </div>
                    ...
                    <form class="form form-horizontal" action="phpcodes-Update.php" method="post">
					 ...
					 $d_m_id = $_POST['d_m_id'];
					  $select="SELECT * FROM `pantra`.`medicines` WHERE d_m_id='$d_m_id'";
                        ...
                        <div class='form-group row'>
                          <label class='col-md-3 label-control' for='projectinput4'> Starting Date</label>
                          <div class='col-md-9'>
                            <input type='text' id='d_m_startingdate' class='form-control' value='$d_m_startingdate' name='d_m_startingdate'>
                          </div>
                        </div>
