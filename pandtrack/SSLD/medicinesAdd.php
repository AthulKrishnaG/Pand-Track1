                ...
                <div class="card-body">
                  ...
                  <form class="form form-horizontal" action="phpcodes-Insert.php" method="post" onsubmit="return validateMedicinesForm()">
                    <div class="form-body">
                      ...
                      <div class="form-group row">
                        <label class="col-md-3 label-control" for="d_m_startingdate">Medicines Starting Date</label>
                        <div class="col-md-9">
                          <input type="date" id="d_m_startingdate" class="form-control" name="d_m_startingdate" required max="<?php echo date('Y-m-d'); ?>">
                        </div>
                      </div>
