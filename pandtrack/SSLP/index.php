          ...
          <div class="rev_slider" data-version="5.0">
            <ul>
              ...
              <li data-index="rs-1" data-transition="random" data-slotamount="7"  data-easein="default" data-easeout="default" data-masterspeed="1000"  data-thumb="http://placehold.it/1920x1280"  data-rotate="0"  data-fstransition="fade" data-fsmasterspeed="1500" data-fsslotamount="7" data-saveperformance="off"  data-title="Intro" data-description="">
                <!-- MAIN IMAGE -->
                <img src="images/pantamicimg/b.jpg"  alt=""  data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" class="rev-slidebg" data-bgparallax="5" data-no-retina>
                <!-- LAYERS -->
                ...
                <div class="tp-caption BigBold-Title tp-resizeme rs-parallaxlevel-0 text-uppercase"
                  ...
                  style="z-index: 6; white-space: nowrap;">PANDEMIC<span class="text-theme-colored">TRACKER</span>
                </div>
                ...
                <div class="tp-caption BigBold-SubTitle tp-resizeme rs-parallaxlevel-0"
                  ...
                  data-basealign="slide" 
                  data-responsive_offset="on"
                  style="z-index: 7; min-width: 410px; max-width: 410px; max-width: 60px; max-width: 60px; white-space: normal;">A secure, user‐friendly platform that enables medical officers to monitor and manage patient data, symptoms, and hotspot areas across Kerala.</div>

                <!-- LAYER NR. 3 -->
                <div class="tp-caption btn btn-default btn-transparent btn-flat btn-lg btn-theme-colored pl-40 pr-40 rs-parallaxlevel-0"
                  id="rs-1-layer-3"
                  data-x="['left','left','left','left']" 
                  ...
                  data-basealign="slide" 
                  data-responsive_offset="on"
                  style="z-index: 8; white-space: nowrap;outline:none;box-shadow:none;box-sizing:border-box;-moz-box-sizing:border-box;-webkit-box-sizing:border-box;">EXPLORE NOW 
                </div>
              </li>
              ...
              <li data-index="rs-2" data-transition="random" data-slotamount="7"  data-easein="default" data-easeout="default" data-masterspeed="1000"  data-thumb="http://placehold.it/1920x1280"  data-rotate="0"  data-fstransition="fade" data-fsmasterspeed="1500" data-fsslotamount="7" data-saveperformance="off"  data-title="Intro" data-description="">
                <!-- MAIN IMAGE -->
                <img src="images/pantamicimg/pantrahsptl.jpg"  alt=""  data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" class="rev-slidebg" data-bgparallax="5" data-no-retina>
                <!-- LAYERS -->
                ...
                <div class="tp-caption BigBold-Title tp-resizeme rs-parallaxlevel-0 text-uppercase"
                  ...
                  data-basealign="slide" 
                  data-responsive_offset="on"
                  style="z-index: 6; white-space: nowrap;"><span class="text-theme-colored">WE</span>CARE
                </div>
                ...
                <div class="tp-caption BigBold-SubTitle tp-resizeme rs-parallaxlevel-0"
                  ...
                  data-basealign="slide" 
                  data-responsive_offset="on"
                  style="z-index: 7; min-width: 410px; max-width: 410px; max-width: 60px; max-width: 60px; white-space: normal;">A secure, user‐friendly platform that enables medical officers to monitor and manage patient data, symptoms, and hotspot areas across Kerala. 
                </div>
                ...
                <div class="tp-caption btn btn-default btn-transparent btn-flat btn-lg pl-40 pr-40 rs-parallaxlevel-0"
                  ...
                  data-basealign="slide" 
                  data-responsive_offset="on"
                  style="z-index: 8; white-space: nowrap;border-color:rgba(255, 255, 255, 0.25);outline:none;box-shadow:none;box-sizing:border-box;-moz-box-sizing:border-box;-webkit-box-sizing:border-box;">EXPLORE NOW 
                </div>
              </li>
              ...
              <li data-index="rs-3" data-transition="random" data-slotamount="7"  data-easein="default" data-easeout="default" data-masterspeed="1000"  data-thumb="http://placehold.it/1920x1280"  data-rotate="0"  data-fstransition="fade" data-fsmasterspeed="1500" data-fsslotamount="7" data-saveperformance="off"  data-title="Intro" data-description="">
                <!-- MAIN IMAGE -->
                <img src="images/pantamicimg/a.jpg"  alt=""  data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" class="rev-slidebg" data-bgparallax="5" data-no-retina>
                <!-- LAYERS -->
                ...
                <div class="tp-caption BigBold-Title tp-resizeme rs-parallaxlevel-0"
                  ...
                  data-basealign="slide" 
                  data-responsive_offset="on"
                  style="z-index: 6; white-space: nowrap;"><span class="text-theme-colored">HEALTHY</span> WORLD
                </div>
                ...
                <!-- LAYER NR. 3 -->
                <div class="tp-caption btn btn-default btn-transparent btn-lg btn-flat pl-40 pr-40 rs-parallaxlevel-0"
        ...
        <div class="section-title text-center">
          <div class="row">
            <div class="col-md-8 col-md-offset-2">
              <h3 class="text-uppercase mt-0">Our Doctors</h3>
          ...
          <div class="row multi-row-clearfix">
            <div class="col-md-12 text-left sm-text-center">
              <div class="volunteers-carousel owl-nav-top" data-dots="true">
                <?php
						$select="SELECT * FROM `pantra`.`user` WHERE urole='Doctor'";
						$result=mysqli_query($dbconnection, $select);
						$num = mysqli_num_rows($result);
						$i=0;
                ...
                <div class='item'>
                  <div class='volunteer maxwidth400'>
                    <div class='thumb'><img alt='' src='images/user/$uimg' class='img-fullwidth'></div>
                    <div class='overlay'>
                      <div class='content text-center'>
                        <h4 class='author mb-0'><a href='#' class='text-white'>$uname</a></h4>
                        <h6 class='title text-black font-14 mt-5 mb-15'>$udesignation</h6>
