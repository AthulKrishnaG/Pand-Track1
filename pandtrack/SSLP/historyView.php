        ...
        <div class="section-content text-center">
          <div class="row"> 
            <div class="col-md-6 col-md-offset-3 text-center">
              <h2 class="text-theme-colored font-36">My History Entries</h2>
    ...
    <section class="divider parallax layer-overlay overlay-deep" data-stellar-background-ratio="0.2" data-bg-img="">
      <div class="container">
        <div class="section-content text-center">
          <div class="row">
            <div class="col-md-12">
              <h3 class="mt-0">Your Submitted History</h3>
                ...
                <table class="table table-hover table-bordered">
                  <?php
                    ...
                    $select = "
                      SELECT 
                        h_id,
                        h_days_after_the_onset_of_the_disease,
                        h_effective_medicines,
                        h_in_date
                      FROM `pantra`.`history`
                      WHERE h_patient = '$uID'
                    ...
                    echo "
                      <thead> 
                        <tr> 
                          <th>#</th> 
                          <th>Days After Onset</th>
                          <th>Effective Medicines</th>
                          <th>Submitted On</th>
                        </tr> 
                      </thead> 
                      <tbody>
                    ...
                    if ($num > 0) {
                      while ($row = mysqli_fetch_assoc($result)) {
                        $i++;
                        $hid       = $row['h_id'];
                        $daysAfter = htmlspecialchars($row['h_days_after_the_onset_of_the_disease']);
                        $meds      = htmlspecialchars($row['h_effective_medicines']);
                        $in_date   = $row['h_in_date'];
                      ...
                      echo "
                        <tr>
                          <td colspan='4' class='text-center'>No history entries found.</td>
                        </tr>
                      ";
                    }
