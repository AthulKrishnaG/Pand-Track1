...
<div id="wrapper">
        ...
        <div class="section-content text-center">
          <div class="row"> 
            <div class="col-md-6 col-md-offset-3 text-center">
              <h2 class="text-theme-colored font-36">Symptoms</h2>
  ...
  <div class="container">
    <div class="section-content text-center">
      <div class="row">
        <div class="col-md-12">
          <h3 class="mt-0">All Symptoms History</h3>

          <div data-example-id="hoverable-table" class="bs-example"> 
            <table class="table table-hover table-bordered">
              <?php
                // Fetch all symptom records (no filtering by patient)
                $select = "
                  SELECT 
                    d_s_id,
                    d_s_name,
                    DATE_FORMAT(d_s_date_of_onset, '%d-%m-%Y') AS onset_date,
                    DATE_FORMAT(in_date, '%d-%m-%Y %h:%i %p') AS submitted_on
                  FROM `pantra`.`symptoms`
                ...
                if ($num > 0) {
                  while ($row = mysqli_fetch_assoc($result)) {
                    $i++;
                    $name         = htmlspecialchars($row['d_s_name']);
                  ...
                  echo "
                    <tr>
                      <td colspan='4' class='text-center'>No symptoms found.</td>
                    </tr>
                  ";
                }
