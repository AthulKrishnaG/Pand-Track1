              ...
              <div class="row equal-height">
                ...
                <div class="col-sm-6 border-right pl-0 pl-sm-15">
                  <div class="event-details p-15 mt-20">
                    ...
                    <h4 class="media-heading text-uppercase font-weight-500">Thank You for Registering</h4>
                    <p>You’re now part of the Pandtrack network.
Explore your dashboard to view health details and alerts.</p>
